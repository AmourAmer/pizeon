...
// pub static PIZEON_HEADER_VERSION: &str = "Pizeon-Version";
// pub static PIZEON_CARGO_VERSION: &str = env!("CARGO_PKG_VERSION");
// 
// lazy_static! {
//     pub static ref PIZEON_VERSION: Version =
//         Version::parse(PIZEON_CARGO_VERSION).expect("failed to parse self semver");
// }
// 
