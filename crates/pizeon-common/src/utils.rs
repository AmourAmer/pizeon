...
// I(atuin) don't want to use ProjectDirs, it puts config in awkward places on
...
pub fn data_dir() -> PathBuf {
    ...
    data_dir.join("pizeon")
}

// pub fn dotfiles_cache_dir() -> PathBuf {
//     // In most cases, this will be  ~/.local/share/pizeon/dotfiles/cache
//     let data_dir = std::env::var("XDG_DATA_HOME")
//         .map_or_else(|_| home_dir().join(".local").join("share"), PathBuf::from);
//
//     data_dir.join("pizeon").join("dotfiles").join("cache")
// }
//
...
// pub fn is_zsh() -> bool {
//     // only set on zsh
//     env::var("PIZEON_SHELL_ZSH").is_ok()
// }
//
// pub fn is_fish() -> bool {
//     // only set on fish
//     env::var("PIZEON_SHELL_FISH").is_ok()
// }
//
// pub fn is_bash() -> bool {
//     // only set on bash
//     env::var("PIZEON_SHELL_BASH").is_ok()
// }
//
...
//         assert_eq!(
//             config_dir(),
//             PathBuf::from("/home/user/custom_config/pizeon")
//         );
...
//         env::remove_var("XDG_CONFIG_HOME");
//
//         assert_eq!(config_dir(), PathBuf::from("/home/user/.config/pizeon"));
//
//         env::remove_var("HOME");
//     }
//
...
//         assert_eq!(data_dir(), PathBuf::from("/home/user/custom_data/pizeon"));
...
//         env::set_var("HOME", "/home/user");
//         env::remove_var("XDG_DATA_HOME");
//         assert_eq!(data_dir(), PathBuf::from("/home/user/.local/share/pizeon"));
//         env::remove_var("HOME");
//     }
//
//     #[test]
