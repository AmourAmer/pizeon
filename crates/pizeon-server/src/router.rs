...
// use pizeon_common::api::{ErrorResponse, PIZEON_CARGO_VERSION, PIZEON_HEADER_VERSION};
// use axum::{
...
//     settings::Settings,
// };
// use pizeon_server_database::{models::User, Database, DbError};
// 
...
//     response
//         .headers_mut()
//         .insert(PIZEON_HEADER_VERSION, PIZEON_CARGO_VERSION.parse().unwrap());
// 
//     response
// }
// 
