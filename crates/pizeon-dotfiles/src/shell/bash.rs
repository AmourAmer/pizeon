...
//                 format!("echo 'Pizeon: failed to read and generate aliases: \n{r}\n{e}'",)
//             })
//         }
//     }
// }
...
// 
//             store.posix().await.unwrap_or_else(|e| {
//                 format!("echo 'Pizeon: failed to read and generate vars: \n{r}\n{e}'",)
//             })
//         }
//     }
// }
...
// ///
// /// In the worst case, Pizeon should not function but the shell should start correctly.
// ///
...
//     let aliases = pizeon_common::utils::dotfiles_cache_dir().join("aliases.bash");
// 
//     if aliases.exists() {
...
//         return format!("echo 'Pizeon: failed to generate aliases: {}'", e);
//     }
// 
...
//     // First try to read the cached config
//     let vars = pizeon_common::utils::dotfiles_cache_dir().join("vars.bash");
// 
//     if vars.exists() {
...
// 
//     if let Err(e) = store.build().await {
//         return format!("echo 'Pizeon: failed to generate vars: {}'", e);
//     }
// 
