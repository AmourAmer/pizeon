...
use pizeon_common::record::{Diff, HostId, RecordId, RecordIdx, RecordStatus};
...
#[cfg(test)]
mod tests {
    use pizeon_common::record::{Diff, EncryptedData, HostId, Record};
    ...
    fn test_record() -> Record<EncryptedData> {
        Record::builder()
            .host(pizeon_common::record::Host::new(HostId(
                pizeon_common::utils::uuid_v7(),
            )))
            .version("v1".into())
