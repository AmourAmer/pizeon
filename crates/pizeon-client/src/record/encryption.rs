...
// 1000 pizeon records a day, that would only cost them $1 and 10 cent a month.
// 
...
//         let payload = serde_json::to_string(&PizeonPayload {
...
//             .expect("error encrypting pizeon data");
// 
//         EncryptedData {
//             data: token,
...
// 
//         let payload: PizeonPayload = serde_json::from_str(&payload)?;
...
// 
//         let PizeonFooter { kid, wpk } = serde_json::from_str(&wrapped_cek)
