// Here we(atuin) are using sqlite as a pretty dumb store, and will not be running any complex queries.
...
//         Record::builder()
//             .host(Host::new(HostId(pizeon_common::utils::uuid_v7())))
//             .version("v1".into())
//             .tag(pizeon_common::utils::uuid_v7().simple().to_string())
//             .data(EncryptedData {
//                 data: "1234".into(),
