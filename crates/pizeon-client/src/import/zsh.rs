...
mod test {
    ...
    fn test_parse_extended_simple() {
        let parsed = parse_extended("1613322469:0;cargo install pizeon", 0);

        assert_eq!(parsed.command, "cargo install pizeon");
        ...
        let parsed = parse_extended("1613322469:10;cargo install pizeon;cargo update", 0);

        assert_eq!(parsed.command, "cargo install pizeon;cargo update");
    ...
    async fn test_parse_file() {
        let bytes = r": 1613322469:0;cargo install pizeon
: 1613322469:10;cargo install pizeon; \
cargo update
