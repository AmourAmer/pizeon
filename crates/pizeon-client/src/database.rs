...
//     let Ok(session) = env::var("PIZEON_SESSION") else {
//         eprintln!("ERROR: Failed to find $PIZEON_SESSION in the environment. Check that you have correctly set up your shell.");
//         std::process::exit(1);
//     };
