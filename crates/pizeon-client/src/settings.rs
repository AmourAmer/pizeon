...
// ///
// /// See: https://github.com/pizeonsh/pizeon/pull/1517#discussion_r1447516426
...
impl Settings {
    ...
    //         }
    //
    //         let uuid = pizeon_common::utils::uuid_v7();
    //
    ...
    //             // Worst case, we don't want Pizeon to fail to start because something funky is going on with
    //             // version checking.
