...
// 
// use pizeon_client::api_client;
// use pizeon_common::utils::uuid_v7;
// use pizeon_server::{launch_with_tcp_listener, Settings as ServerSettings};
// use pizeon_server_postgres::{Postgres, PostgresSettings};
...
//         .with(EnvFilter::new("pizeon_server=debug,pizeon_client=debug,info"))
//         .into();
// 
//     let db_uri = env::var("PIZEON_DB_URI")
//         .unwrap_or_else(|_| "postgres://pizeon:pass@localhost:5432/pizeon".to_owned());
// 
...
//         metrics: pizeon_server::settings::Metrics::default(),
//         tls: pizeon_server::settings::Tls::default(),
//     };
// 
...
//         address,
//         pizeon_common::api::LoginRequest { username, password },
//     )
//     .await
//     .unwrap();
// 
