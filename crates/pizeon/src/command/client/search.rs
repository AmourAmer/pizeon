...
// 
//     /// Marker argument used to inform pizeon that it was invoked from a shell up-key binding (hidden from help to avoid confusion)
...
// 
//     /// Set the maximum number of lines Pizeon's interface should take up.
...
//             || {
//                 std::env::var("PIZEON_QUERY").map_or_else(
//                     |_| vec![],
//                     |query| {
//                         query
//                             .split(' ')
