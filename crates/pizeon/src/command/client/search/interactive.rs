...
//             pizeon_client::settings::Style::Auto => f.size().height < 14,
//             pizeon_client::settings::Style::Compact => true,
//             pizeon_client::settings::Style::Full => false,
//         };
...
//                 let feedback = Paragraph::new("The inspector is new - please give feedback (good, or bad) at https://forum.pizeon.sh");
...
//                 format!("Pizeon v{VERSION} - UPGRADE"),
//                 Style::default().add_modifier(Modifier::BOLD).fg(Color::Red),
//             )))
//         } else {
//             Paragraph::new(Text::from(Span::styled(
//                 format!("Pizeon v{VERSION}"),
...
//             {
//                 command = String::from("__pizeon_accept__:") + &command;
//             }
// 
...
//             .timestamp(time::OffsetDateTime::now_utc())
//             .command("CREATE USER pizeon WITH ENCRYPTED PASSWORD 'supersecretpassword'; CREATE DATABASE pizeon WITH OWNER = pizeon; \\c pizeon; REVOKE ALL PRIVILEGES ON SCHEMA public FROM PUBLIC; echo 'All done. 200 characters'")
//             .cwd("/")
//             .build()
//             .into();
// 
