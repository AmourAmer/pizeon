...
// 
// use pizeon_client::{encryption, record::sqlite_store::SqliteStore, settings::Settings};
...
//     shell: Shell,
// 
//     /// Disable the binding of CTRL-R to pizeon
//     #[clap(long)]
//     disable_ctrl_r: bool,
// 
//     /// Disable the binding of the Up Arrow key to pizeon
//     #[clap(long)]
...
// impl Cmd {
//     fn init_nu(&self) {
//         let full = include_str!("../../shell/pizeon.nu");
//         println!("{full}");
// 
//         if std::env::var("PIZEON_NOBIND").is_err() {
...
//             event: { send: executehostcommand cmd: (_pizeon_search_cmd) }
//         }
//     )
// )";
...
//                 until: [
//                     {send: menuup}
//                     {send: executehostcommand cmd: (_pizeon_search_cmd '--shell-up-key-binding') }
//                 ]
//             }
//         }
//     )
