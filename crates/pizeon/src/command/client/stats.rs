...
// pub struct Cmd {
//     /// Compute statistics for the specified period, leave blank for statistics since the beginning. See https://docs.pizeon.sh/reference/stats/ for more details.
//     period: Vec<String>,
// 
...
//     for i in history {
//         // just in case it somehow has a leading tab or space or something (legacy pizeon didn't ignore space prefixes)
